...
#   _identity = load_agent_identity("summarizer")
    ...
    with tracer.start_as_current_span("agent.bootstrap") as span:
        ...
        try:
            ...
            agent_registry.register(
                ...
                endpoint=os.getenv("SERVICE_URL", "http://localhost:8006"),
            )
...
@app.post("/run", response_model=SummarizerOutput)
@limiter.limit("30/minute")
async def run(request: Request, payload: SummarizerInput):
