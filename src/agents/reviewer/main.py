...
from src.common.schemas import ReviewerInput, ReviewerOutput
...
#   _identity = load_agent_identity("reviewer")
...
async def startup() -> None:
    ...
    with tracer.start_as_current_span("agent.bootstrap") as span:
        ...
        agent_id = os.getenv("AGENT_ID", "reviewer")
        try:
            ...
            agent_registry.register(
                ...
                endpoint=os.getenv("SERVICE_URL", "http://localhost:8007"),
            )
...
async def run(request: Request, payload: ReviewerInput):
